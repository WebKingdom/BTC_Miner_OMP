...
WORD* InitializeK() {
    // WORD* k = new WORD[64]{0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5,
...
char* gpu_sha256(const char* input, const WORD* sha256_k) {
    ...
    Update((unsigned char*)input, strlen(input), sha256_k, sha256H, msgBlock, msgTotalLen, msgLen);
    Final(digest, sha256_k, sha256H, msgBlock, msgTotalLen, msgLen);
